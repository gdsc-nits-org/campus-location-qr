...
const LOCATIONS = [
  ...
  },
  {
    slug: 'canteen',
    name: 'Main Canteen',
    description: 'Central food court serving breakfast, lunch, snacks, and dinner. Open 7 AM – 10 PM.',
    category: 'Food',
    latitude: 12.9722,
    longitude: 77.5952,
...
async function main() {
  ...
  console.log('✅ Super Admin created (84agarwalharshit@gmail.com / campus@2024)')
